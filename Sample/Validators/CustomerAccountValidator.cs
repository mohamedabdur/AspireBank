...
public class CustomerAccountValidator : AbstractValidator<CustomerAccountInfoDTO>
{
    public CustomerAccountValidator()
    {
        ...
        RuleFor(x => x.AgreedToPrivacyPolicy)
        .Equal(true).WithMessage("must agree to PrivacyPolicy");

        RuleFor(x => x.AgreedToTermsAndConditions)
        .Equal(true).WithMessage("must agree to TermsAndConditions");
